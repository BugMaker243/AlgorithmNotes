...
public class T_MyPriorityQueue<T> {
    private T[] heap;
    private int size;
    private final Comparator<? super T> comparator;

    @SuppressWarnings("unchecked")
    public T_MyPriorityQueue(int capacity, Comparator<? super T> comparator) {
    ...
    public static void main(String[] args) {
        T_MyPriorityQueue<Integer> pq = new T_MyPriorityQueue<>(3, Comparator.naturalOrder());
        pq.push(3);
        pq.push(1);
        pq.push(4);
        pq.push(1);
